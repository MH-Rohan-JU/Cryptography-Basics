from modules.hash import verify_integrity, hash_file
...
while True:
    ...
    if choice == "0":
        ...
        key, ciphertext, plaintext = aes_encrypt_decrypt(message)
        print("AES Key: ", key)
        ...
        message = input("Enter message: ")
        ciphertext, password = rsa_encrypt_decrypt(message)
        print("RSA message, encrypted with a private key: ", ciphertext)
        print("RSA message, decrypted with a private key: ", password)
...
print("Agent! you're quiting your cryptography toolkit. Stay secured there!")